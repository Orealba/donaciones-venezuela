export function createHeroMessage(): HTMLElement {
  ...
  h1.textContent = 'Si estás aquí es porque abriste una caja nuestra';

  const h3 = document.createElement('h3');
  h3.className = 'text-lg md:text-xl lg:text-2xl text-stone-600';
  h3.textContent =
    'En estos días difíciles, les enviamos esta ayuda desde  Barcelona, de parte de hermanos de distintas nacionalidades que creemos en ustedes.';
