export function createThanksPage(onBack: () => void): HTMLElement {
  ...
  h3.textContent = 'Gracias, juntos saldremos de esta.'

  const p = document.createElement('p')
  p.className = 'text-xs md:text-sm text-stone-600'
  p.textContent =
    'Tu mensaje nos llegó. Seguiremos trabajando para que la ayuda llegue a quienes más la necesitan.'
